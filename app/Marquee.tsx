...
export default function Marquee() {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 overflow-hidden relative py-2.5 shadow-lg border-y border-emerald-600/30">
      <style>{`
        @keyframes marquee {
          0% {
      ...
      <div className="marquee-container relative overflow-hidden">
        <div className="marquee-text font-semibold text-xs md:text-sm text-emerald-300 drop-shadow-lg">
          {message}
        </div>
      </div>
